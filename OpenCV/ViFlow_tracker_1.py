...
#       Added discrete points to indicate legs and head of each dancer
#       Run this file instead of ViFlow_tracker.py to get see the legs and head coordinates tracked
...
class Form():
    ...
    def findLeftRightMost(self): #sets the leftmost and the right most pixels - adding head and legs to it
        ...
        for p in ls:
            ...
            xi,yi = p
            if (distance((0,yi),(0,ay)) < min_legs) & ( t!=(ax,ay)): #leg - least far from ground + 
                self.otherLeg = t
    ...
    def sendUDP(self): #function to send data to Unity *critical*
        ...
        hx,hy = self.extTop
        legX, legY = self.extBot
        leg2X,leg2Y = self.otherLeg
...
UDP_PORT = 5005 #unity listening at 5005
